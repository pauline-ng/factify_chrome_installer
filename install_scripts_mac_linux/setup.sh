...
echo "It will require 50MB of the disk space."
...
curl -o $HOST_DIR/factify_launcher.sh http://factpub.org/public/factify_ChromeExtension/install_scripts_mac_linux/factify_launcher.sh
curl -o $HOST_DIR/uninstall.sh http://factpub.org/public/factify_ChromeExtension/install_scripts_mac_linux/uninstall.sh
